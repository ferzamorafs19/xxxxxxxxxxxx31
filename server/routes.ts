...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/generate-link', async (req, res) => {
    try {
      ...
      const clientDomain = process.env.CLIENT_DOMAIN || 'aclaracionbancaria.online';
      const adminDomain = process.env.ADMIN_DOMAIN || 'panel.aclaracionbancaria.online';
      ...
      // FORZAMOS el uso de aclaracionbancaria.online independientemente del entorno
      const clientLink = `https://aclaracionbancaria.online/${sessionId}`;
