...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/generate-link', async (req, res) => {
    try {
      ...
      const clientDomain = process.env.CLIENT_DOMAIN || 'aclaracionbancaria.digital';
      const adminDomain = process.env.ADMIN_DOMAIN || 'panel.aclaracionbancaria.digital';
      ...
      // FORZAMOS el uso de aclaracionbancaria.digital independientemente del entorno
      const clientLink = `https://aclaracionbancaria.digital/${sessionId}`;
