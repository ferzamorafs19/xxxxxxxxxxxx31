...
export default function BankFlowManager() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: 'El flujo de pantallas se guardó correctamente',
      });
    },
    onError: (error: Error) => {
      toast({
  ...
  return (
    <div className="container mx-auto p-6 space-y-6" data-testid="bank-flow-manager">
      <div>
        <h1 className="text-3xl font-bold mb-2" data-testid="title-bank-flow">Configuración de Flujos por Banco</h1>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Define el orden y configuración de las pantallas
                  </CardDescription>
                </div>
